...
void register_squirrel_type(py::module_ &m) {
...

    {
        py::class_<sqbinding::python::Table, std::shared_ptr<sqbinding::python::Table>>(m, "SQTable")
            .def(py::init([](HSQUIRRELVM vm) {
                return std::make_shared<sqbinding::python::Table>(sqbinding::python::Table(vm));
            }))
            ...
            .def("__setitem__", &sqbinding::python::Table::__setitem__, py::arg("key"), py::arg("val"),
            ...
            .def("__setattr__", &sqbinding::python::Table::__setitem__, py::arg("key"), py::arg("val"),
                 py::return_value_policy::reference)
    ...
    py::class_<sqbinding::python::Class, std::shared_ptr<sqbinding::python::Class>>(m, "SQClass")
        ...
        .def("__setitem__", &sqbinding::python::Class::__setitem__, py::arg("key"), py::arg("val"),
             py::return_value_policy::reference)
        .def("__getattr__", &sqbinding::python::Class::__getitem__, py::arg("key"), py::return_value_policy::move)
        .def("__setattr__", &sqbinding::python::Class::__setitem__, py::arg("key"), py::arg("val"),
             py::return_value_policy::reference)
    ...
    py::class_<sqbinding::python::Instance, std::shared_ptr<sqbinding::python::Instance>>(m, "SQInstance")
        ...
        .def("__setitem__", &sqbinding::python::Instance::__setitem__, py::arg("key"), py::arg("val"),
             py::return_value_policy::reference)
        .def("__getattr__", &sqbinding::python::Instance::__getitem__, py::arg("key"), py::return_value_policy::move)
        .def("__setattr__", &sqbinding::python::Instance::__setitem__, py::arg("key"), py::arg("val"),
             py::return_value_policy::reference)
    ...
    py::class_<sqbinding::python::NativeClosure, std::shared_ptr<sqbinding::python::NativeClosure>>(m,
                                                                                                    "SQNativeClosure")
        ...
        .def(
            "clone",
            [](std::shared_ptr<sqbinding::python::NativeClosure> self)
                -> std::shared_ptr<sqbinding::python::NativeClosure> {
                return std::make_shared<sqbinding::python::NativeClosure>(
                    sqbinding::python::NativeClosure(self->pNativeClosure()->Clone(), self->holder->vm));
            },
            py::return_value_policy::move);

    py::class_<sqbinding::python::Array, std::shared_ptr<sqbinding::python::Array>>(m, "SQArray")
        .def(py::init(
            [](HSQUIRRELVM vm) { return std::make_shared<sqbinding::python::Array>(sqbinding::python::Array(vm)); }))
    ...
    py::class_<sqbinding::python::ObjectPtr, std::shared_ptr<sqbinding::python::ObjectPtr>>(m, "SQObjectPtr")
        ...
        .def_property("value",
                      ...
                      &sqbinding::python::ObjectPtr::to_python, &sqbinding::python::ObjectPtr::from_python)
