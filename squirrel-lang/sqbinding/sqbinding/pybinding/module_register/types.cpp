...
void register_squirrel_type(py::module_ &m) {
...

    {
        ...
        .def("__setitem__", &sqbinding::python::Table::__setitem__, py::arg("key"), py::arg("val"), py::return_value_policy::reference)
        ...
        .def("__setattr__", &sqbinding::python::Table::__setitem__, py::arg("key"), py::arg("val"), py::return_value_policy::reference)
    ...
    .def("__setitem__", &sqbinding::python::Class::__setitem__, py::arg("key"), py::arg("val"), py::return_value_policy::reference)
    ...
    .def("__setitem__", &sqbinding::python::Instance::__setitem__, py::arg("key"), py::arg("val"), py::return_value_policy::reference)
