...
void register_squirrel_type(py::module_ &m) {
    ...
    .def("__getitem__", &_SQTable_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    ...
    .def("__getattr__", &_SQTable_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    ...
    .def("__getitem__", &_SQClass_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    .def("__setitem__", &_SQClass_::__setitem__, py::arg("key"), py::arg("val"), py::keep_alive<1, 3>(), py::return_value_policy::reference)
    .def("__getattr__", &_SQClass_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    ...
    .def("__getitem__", &_SQInstance_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    .def("__setitem__", &_SQInstance_::__setitem__, py::arg("key"), py::arg("val"), py::keep_alive<1, 3>(), py::return_value_policy::reference)
    .def("__getattr__", &_SQInstance_::__getitem__, py::arg("key"), py::keep_alive<0, 1>(), py::return_value_policy::move)
    ...
    .def("__getitem__", &_SQArray_::__getitem__, py::arg("idx"), py::keep_alive<0, 1>(), py::return_value_policy::move)
